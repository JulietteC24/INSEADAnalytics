...
Yes, the high correlations make sense. From our analysis, the questions can be grouped. For instance, questions 3, 9, and 26 all refer to boats representing a status symbol for the customer. For questions 13-17, these questions all refer to the customers’ knowledge on the boat, knowing the right technology and worth of boats and its accessories. Questions 16, 18, 20, 27, and 28 pertain to the customer’s view of boating as his or her passion (“how passionate the customer is towards boating”). 

2. The high correlations then imply that these questions are related to each other, and because they are related, they have low individual contribution or impact to the model.
...
1. For the first factor (component 1), the questions with significant values refer to boats as a status symbol for the customer. For the second factor (component 2), questions pertain to lifestyle where the customer treats their boats as rewards for their hard work, needing to go on an adventure. These two factors were considered the first and second component as they heavily influence the behavior of the customers towards their boats, how they value boats, which makes a lot of business sense.
...
3. Looking at the questions within each factor, the significant ones were considered, and the following interpretation were derived. For the first factor, having high eigenvalue and explanatory power, refers to the value of boats for each customer if they treat boats as a status symbol or not. For the second factor, the questions pertain to lifestyle or how the boats will be used or is used by the customers. For the third factor, questions who how customers appreciate boat quality and brand. For the fourth factor, the questions determine the level of expertise of the customers, following from the appreciation of customers on boat quality. Lastly, the fifth factor has questions on practicality. These factors or grouping of questions help in focusing on the key behavior of customers.

4. Data science techniques are very helpful in deriving useful insights from the data that would be otherwise difficult to digest and explain to the business. In this specific case, these techniques enables us to intrepret the customer responses to a survey and understand what factors customer appreciate when making a purchase decision.
